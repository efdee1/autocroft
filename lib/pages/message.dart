...
//       appBar: AppBar(
//           title: (isConnecting
//               ? Text('Connecting chat to ' + widget.server.address + '...')
//               : isConnected
//                   ? Text('Live chat with ' + widget.server.address)
//                   : Text('Chat log with ' + widget.server.address))),
//       body: SafeArea(
//         child: Column(
//           children: <Widget>[
//             Container(
...
//         // connection.output.add(Uint8List.encode(text + "\r\n"));
